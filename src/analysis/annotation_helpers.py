...
# these functions are identical to those used in data/make_cazyme_tables_helpers.py
# I just call them from the analysis folder in case I want to change them up a bit from the ones
# used in the data prep pipeline.
